      ...
      <nav className="container flex h-14 items-center justify-between gap-4 px-4 md:px-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 shrink-0">
          ...
          <button
            ...
            className="group relative hidden lg:flex items-center"
          >
            <div className="relative flex h-9 rounded-md border border-input bg-background px-4 py-2 text-sm ring-offset-background transition-colors hover:border-primary/30 hover:bg-accent focus-within:border-primary">
              ...
              <div className="ml-auto flex items-center gap-1 pl-4 text-muted-foreground">
          ...
          <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
            ...
            <SheetContent
              side="right"
              className="w-full sm:w-[400px] px-6 flex flex-col"
            >
              <SheetHeader className="space-y-5 pb-6 border-b">
                <SheetTitle>
                  <Link
                    href="/"
                    className="flex items-center space-x-2 font-bold text-lg bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/70"
